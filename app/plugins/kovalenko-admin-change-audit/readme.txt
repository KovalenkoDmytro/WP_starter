...
2. Activate **Kovalenko Admin Change Audit**.
...
This release renames the plugin for WordPress.org review and replaces the old technical prefixes with a unique plugin-specific prefix.
