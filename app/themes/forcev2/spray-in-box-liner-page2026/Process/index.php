...
<section class="process process--home">
  ...
  <div class="process__header">
    <h2 class="process__title">Smooth From Start to Finish</h2>
  </div>
  ...
  <div class="process__steps">
    <div class="process__step">
      ...
      <div class="process__content">
        <h3 class="process__step-title">Get a quote.</h3>
        <p class="process__description">Call or book online. Let us know your truck's year, make, model, and box size so we can give you an accurate price.</p>
      </div>
    </div>
