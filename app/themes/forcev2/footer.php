...
<!--owl javascript -->
<script src="<?php
echo get_template_directory_uri(); ?>/assets/js/owl.carousel.js"></script>
<script src="<?php
echo get_template_directory_uri(); ?>/assets/js/wow.js"></script>

<!--<script src="<?php
//echo get_template_directory_uri(); ?>/assets/js/jquery.event.move.js"></script>-->
<!--   <script src="<?php
//echo get_template_directory_uri(); ?>/assets/js/jquery.twentytwenty.js"></script>-->
